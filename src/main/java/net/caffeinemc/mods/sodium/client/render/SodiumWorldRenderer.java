...
public class SodiumWorldRenderer {
    ...
    public void renderBlockEntities(Map<Integer, DestroyBlockProgress> blockBreakingProgressions,
                                    float tickDelta) {
    ...
    private void renderBlockEntities(Map<Integer, DestroyBlockProgress> blockBreakingProgressions,
                                     ...
                                     double y,
                                     double z,
                                     TileEntityRendererDispatcher blockEntityRenderer,
    ...
    private static void renderBlockEntity(Map<Integer, DestroyBlockProgress> blockBreakingProgressions,
                                          float tickDelta,
                                          double x,
                                          double y,
                                          double z,
