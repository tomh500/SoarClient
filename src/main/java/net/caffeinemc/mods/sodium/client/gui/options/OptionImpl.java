...
public class OptionImpl<S, T> implements OptionExtended<T> {
    ...
    private final Function<T, IChatComponent> tooltip;
    ...
    private OptionImpl(OptionStorage<S> storage,
                       IChatComponent name,
                       Function<T, IChatComponent> tooltip,
    ...
    public static class Builder<S, T> {
        ...
        private Function<T, IChatComponent> tooltip;
        ...
        public Builder<S, T> setTooltip(Function<T, IChatComponent> tooltip) {
            Validate.notNull(tooltip, "Argument must not be null");
