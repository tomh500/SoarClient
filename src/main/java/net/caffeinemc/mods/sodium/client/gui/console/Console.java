...
public class Console implements ConsoleSink {
    ...
    @Override
    public void logMessage(@NotNull MessageLevel level, @NotNull IChatComponent text, double duration) {
        Objects.requireNonNull(level);
        Objects.requireNonNull(text);

        this.messages.addLast(new Message(level, text.createCopy(), duration));
    }
