...
public class PlayerConfigurationParser {
	...
	private BufferedImage downloadTextureImage(String texturePath) {
		...
		try {
			...
			Config.warn("Error loading item texture " + texturePath + ": " + ioexception.getClass().getName() + ": "
	...
	private PlayerItemModel downloadModel(String modelPath) {
		...
		try {
			...
			Config.warn("Error loading item model " + modelPath + ": " + exception.getClass().getName() + ": "
