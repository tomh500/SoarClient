...
public class EntityAIFindEntityNearest extends EntityAIBase {
		...
		this.field_179443_c = new Predicate<EntityLivingBase>() {
			public boolean apply(EntityLivingBase p_apply_1_) {
				...
				return p_apply_1_.isInvisible() ? false
						: ((double) p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearest.this.mob) > d0 ? false
	...
	public boolean shouldExecute() {
		...
		List<EntityLivingBase> list = this.mob.worldObj.<EntityLivingBase>getEntitiesWithinAABB(this.field_179439_f,
