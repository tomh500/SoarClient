...
public class EntityArrow extends Entity implements IProjectile {
	...
	public EntityArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase target, float velocity,
			float innacuracy) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public void onUpdate() {
		...
		if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationYaw = this.rotationYaw = (float) (MathHelper.atan2(this.motionX, this.motionZ) * 180.0D
					/ Math.PI);
			this.prevRotationPitch = this.rotationPitch = (float) (MathHelper.atan2(this.motionY, (double) f) * 180.0D
					/ Math.PI);
		}
		...
		if (this.inGround) {
			...
			for (this.rotationPitch = (float) (MathHelper.atan2(this.motionY, (double) f3) * 180.0D
