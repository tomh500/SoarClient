			...
			if (worldIn.rand.nextInt(4) == 0) {
				...
				if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos1)) {
					if (!flag) {
						...
						&& !state.getValue(getPropertyFor(enumfacing1)).booleanValue()) {
					if (!flag) {
					...
					if (pos.getY() > 1) {
						...
						if (block.blockMaterial == Material.air) {
							...
							if (iblockstate1.getValue(NORTH).booleanValue()
									|| iblockstate1.getValue(EAST).booleanValue()
									|| iblockstate1.getValue(SOUTH).booleanValue()
							...
							if (iblockstate3.getValue(NORTH).booleanValue()
									|| iblockstate3.getValue(EAST).booleanValue()
									|| iblockstate3.getValue(SOUTH).booleanValue()
									|| iblockstate3.getValue(WEST).booleanValue()) {
