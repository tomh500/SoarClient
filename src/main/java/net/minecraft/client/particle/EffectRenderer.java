...
public class EffectRenderer {
	...
	public void addBlockDestroyEffects(BlockPos pos, IBlockState state) {
		...
		if (!Soarium.getConfig().animationSettings.particles || !Soarium.getConfig().animationSettings.blockBreak) {
			return;
		}
	...
	public void addBlockHitEffects(BlockPos pos, EnumFacing side) {
		...
		if (!Soarium.getConfig().animationSettings.particles || !Soarium.getConfig().animationSettings.blockBreaking) {
			return;
		}
