...
public class RenderDragon extends RenderLiving<EntityDragon> {
	...
	protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_,
		...
		GlStateManager.rotate((float) (-Math.atan2(f4, f2)) * 180.0F / (float) Math.PI - 90.0F, 0.0F,
				1.0F, 0.0F);
		GlStateManager.rotate((float) (-Math.atan2(f5, f3)) * 180.0F / (float) Math.PI - 90.0F, 1.0F,
				0.0F, 0.0F);
		...
		for (int j = 0; j <= 8; ++j) {
			...
			worldrenderer.pos(f9 * 0.2F, f10 * 0.2F, 0.0D).tex(f11, f8)
					.color(0, 0, 0, 255).endVertex();
			worldrenderer.pos(f9, f10, f6).tex(f11, f7)
