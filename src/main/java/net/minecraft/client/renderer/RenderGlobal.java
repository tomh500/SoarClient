...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
		...
		if (this.renderEntitiesStartupCounter > 0) {
			...
			if (this.isRenderEntityOutlines()) {
				...
				for (int j = 0; j < list.size(); ++j) {
					...
					boolean flag1 = entity3.isInRangeToRender3d(d0, d1, d2) && (entity3.ignoreFrustumCheck
					...
					if ((entity3 != this.mc.getRenderViewEntity() || this.mc.gameSettings.thirdPersonView != 0 || flag)
							&& flag1) {
	...
	public String getDebugInfoRenders() {
		...
		return String.format("C: %d/%d %sD: %d, %s", Integer.valueOf(j), Integer.valueOf(i),
				this.mc.renderChunksMany ? "(s) " : "", Integer.valueOf(this.renderDistanceChunks),
	...
	private RenderChunk getRenderChunkOffset(BlockPos playerPos, RenderChunk renderChunkBase, EnumFacing facing) {
		...
		return MathHelper
				.abs_int(playerPos.getX() - blockpos.getX()) > this.renderDistanceChunks * 16
						? null
						: (blockpos.getY() >= 0 && blockpos.getY() < 256
								? (MathHelper.abs_int(playerPos.getZ() - blockpos.getZ()) > this.renderDistanceChunks
			...
			if (this.mc.gameSettings.shouldRenderClouds() == 2) {
				...
				for (int i1 = -256; i1 < 256; i1 += 32) {
					for (int j1 = -256; j1 < 256; j1 += 32) {
						worldrenderer.pos(i1, f7, j1 + 32)
								.tex((float) (i1) * 4.8828125E-4F + f8, (float) (j1 + 32) * 4.8828125E-4F + f9)
								.color(f1, f2, f3, 0.8F).endVertex();
						worldrenderer.pos(i1 + 32, f7, j1 + 32)
								.tex((float) (i1 + 32) * 4.8828125E-4F + f8, (float) (j1 + 32) * 4.8828125E-4F + f9)
								.color(f1, f2, f3, 0.8F).endVertex();
						worldrenderer.pos(i1 + 32, f7, j1)
								.tex((float) (i1 + 32) * 4.8828125E-4F + f8, (float) (j1) * 4.8828125E-4F + f9)
								.color(f1, f2, f3, 0.8F).endVertex();
						worldrenderer.pos(i1, f7, j1)
								.tex((float) (i1) * 4.8828125E-4F + f8, (float) (j1) * 4.8828125E-4F + f9)
								.color(f1, f2, f3, 0.8F).endVertex();
					}
				}
				...
				for (int k1 = -3; k1 <= 4; ++k1) {
					...
					if (j1 > -1) {
						for (int l1 = 0; l1 < 8; ++l1) {
							worldrenderer.pos(f24 + (float) l1 + 0.0F, f3 + 0.0F, f25 + 8.0F)
									.tex((f22 + (float) l1 + 0.5F) * 0.00390625F + f17,
											(f23 + 8.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(-1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) l1 + 0.0F, f3 + 4.0F, f25 + 8.0F)
									.tex((f22 + (float) l1 + 0.5F) * 0.00390625F + f17,
											(f23 + 8.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(-1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) l1 + 0.0F, f3 + 4.0F, f25 + 0.0F)
									.tex((f22 + (float) l1 + 0.5F) * 0.00390625F + f17,
											(f23 + 0.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(-1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) l1 + 0.0F, f3 + 0.0F, f25 + 0.0F)
									.tex((f22 + (float) l1 + 0.5F) * 0.00390625F + f17,
											(f23 + 0.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(-1.0F, 0.0F, 0.0F).endVertex();
						}
					...
					if (j1 <= 1) {
						for (int i2 = 0; i2 < 8; ++i2) {
							worldrenderer.pos(f24 + (float) i2 + 1.0F - 9.765625E-4F, f3 + 0.0F, f25 + 8.0F)
									.tex((f22 + (float) i2 + 0.5F) * 0.00390625F + f17,
											(f23 + 8.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) i2 + 1.0F - 9.765625E-4F, f3 + 4.0F, f25 + 8.0F)
									.tex((f22 + (float) i2 + 0.5F) * 0.00390625F + f17,
											(f23 + 8.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) i2 + 1.0F - 9.765625E-4F, f3 + 4.0F, f25 + 0.0F)
									.tex((f22 + (float) i2 + 0.5F) * 0.00390625F + f17,
											(f23 + 0.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(1.0F, 0.0F, 0.0F).endVertex();
							worldrenderer.pos(f24 + (float) i2 + 1.0F - 9.765625E-4F, f3 + 0.0F, f25 + 0.0F)
									.tex((f22 + (float) i2 + 0.5F) * 0.00390625F + f17,
											(f23 + 0.0F) * 0.00390625F + f18)
									.color(f26, f27, f28, 0.8F).normal(1.0F, 0.0F, 0.0F).endVertex();
						}
					...
					if (k1 > -1) {
						for (int j2 = 0; j2 < 8; ++j2) {
							worldrenderer.pos(f24 + 0.0F, f3 + 4.0F, f25 + (float) j2 + 0.0F)
									.tex((f22 + 0.0F) * 0.00390625F + f17,
											(f23 + (float) j2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, -1.0F).endVertex();
							worldrenderer.pos(f24 + 8.0F, f3 + 4.0F, f25 + (float) j2 + 0.0F)
									.tex((f22 + 8.0F) * 0.00390625F + f17,
											(f23 + (float) j2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, -1.0F).endVertex();
							worldrenderer.pos(f24 + 8.0F, f3 + 0.0F, f25 + (float) j2 + 0.0F)
									.tex((f22 + 8.0F) * 0.00390625F + f17,
											(f23 + (float) j2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, -1.0F).endVertex();
							worldrenderer.pos(f24 + 0.0F, f3 + 0.0F, f25 + (float) j2 + 0.0F)
									.tex((f22 + 0.0F) * 0.00390625F + f17,
											(f23 + (float) j2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, -1.0F).endVertex();
						}
					...
					if (k1 <= 1) {
						for (int k2 = 0; k2 < 8; ++k2) {
							worldrenderer.pos(f24 + 0.0F, f3 + 4.0F, f25 + (float) k2 + 1.0F - 9.765625E-4F)
									.tex((f22 + 0.0F) * 0.00390625F + f17,
											(f23 + (float) k2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, 1.0F).endVertex();
							worldrenderer.pos(f24 + 8.0F, f3 + 4.0F, f25 + (float) k2 + 1.0F - 9.765625E-4F)
									.tex((f22 + 8.0F) * 0.00390625F + f17,
											(f23 + (float) k2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, 1.0F).endVertex();
							worldrenderer.pos(f24 + 8.0F, f3 + 0.0F, f25 + (float) k2 + 1.0F - 9.765625E-4F)
									.tex((f22 + 8.0F) * 0.00390625F + f17,
											(f23 + (float) k2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, 1.0F).endVertex();
							worldrenderer.pos(f24 + 0.0F, f3 + 0.0F, f25 + (float) k2 + 1.0F - 9.765625E-4F)
									.tex((f22 + 0.0F) * 0.00390625F + f17,
											(f23 + (float) k2 + 0.5F) * 0.00390625F + f18)
									.color(f13, f14, f15, 0.8F).normal(0.0F, 0.0F, 1.0F).endVertex();
						}
	...
	public void drawSelectionBox(EntityPlayer player, MovingObjectPosition movingObjectPositionIn, int execute,
		...
		if (execute == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
			...
			if (block.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos)) {
				...
				drawSelectionBoundingBox(block.getSelectedBoundingBox(this.theWorld, blockpos)
	...
	private EntityFX spawnEntityFX(int particleID, boolean ignoreRange, double xCoord, double yCoord, double zCoord,
		...
		if (this.mc != null && this.mc.getRenderViewEntity() != null && this.mc.effectRenderer != null) {
			...
			if (ignoreRange) {
				return this.mc.effectRenderer.spawnEffectParticle(particleID, xCoord, yCoord, zCoord, xOffset, yOffset,
						zOffset, parameters);
			} else {
				double d3 = 16.0D;
				return d0 * d0 + d1 * d1 + d2 * d2 > 256.0D ? null
						: (i > 1 ? null
								: this.mc.effectRenderer.spawnEffectParticle(particleID, xCoord, yCoord, zCoord,
										xOffset, yOffset, zOffset, parameters));
			}
		} else {
			return null;
		...
		case 2002:
			...
			for (int i1 = 0; i1 < 8; ++i1) {
				this.spawnParticle(EnumParticleTypes.ITEM_CRACK, d13, d14, d16, random.nextGaussian() * 0.15D,
						random.nextDouble() * 0.2D, random.nextGaussian() * 0.15D, Item.getIdFromItem(Items.potionitem),
						data);
			}
		...
		case 2003:
			...
			for (double d18 = 0.0D; d18 < (Math.PI * 2D); d18 += 0.15707963267948966D) {
				this.spawnParticle(EnumParticleTypes.PORTAL, d0 + Math.cos(d18) * 5.0D, d1 - 0.4D,
						d2 + Math.sin(d18) * 5.0D, Math.cos(d18) * -5.0D, 0.0D, Math.sin(d18) * -5.0D);
				this.spawnParticle(EnumParticleTypes.PORTAL, d0 + Math.cos(d18) * 5.0D, d1 - 0.4D,
						d2 + Math.sin(d18) * 5.0D, Math.cos(d18) * -7.0D, 0.0D, Math.sin(d18) * -7.0D);
			}
