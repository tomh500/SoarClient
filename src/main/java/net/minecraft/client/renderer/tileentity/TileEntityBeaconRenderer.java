...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer<TileEntityBeacon> {
	...
	public void renderTileEntityAt(TileEntityBeacon te, double x, double y, double z, float partialTicks,
		...
		if (!Soarium.getConfig().detailSettings.beaconBeam) {
			return;
		}
	...
	/**
	 * If true the {@link TileEntitySpecialRenderer} will always be rendered while
	 * the player is in the render bounding box
	 * {@link TileEntity#getRenderBoundingBox()} and his squared distance with the
	 * {@link TileEntity} is smaller than
	 * {@link TileEntity#getMaxRenderDistanceSquared()}.
	 */
