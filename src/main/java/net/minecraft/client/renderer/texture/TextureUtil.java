...
import com.soarclient.libraries.patches.textures.NativeBackedImage;
...
public class TextureUtil {
	...
	private static void uploadTextureSub(int p_147947_0_, int[] p_147947_1_, int p_147947_2_, int p_147947_3_,
		...
		for (int j = 0; j < p_147947_2_ * p_147947_3_; j += p_147947_2_ * l) {
			...
			GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, p_147947_0_, p_147947_4_, p_147947_5_ + k, p_147947_2_, l,
	...
	public static BufferedImage readBufferedImage(InputStream imageStream) throws IOException {
		return NativeBackedImage.make(imageStream);
	}
