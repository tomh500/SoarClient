...
public class SliderControlExtended implements Control<Integer> {
    ...
    private static class Slider extends ControlElement<Integer> {
        ...
        private void renderStandaloneValue() {
            ...
            IChatComponent label = this.formatter.format(this.option.getValue());
        ...
        private void renderSlider() {
            ...
            IChatComponent label = this.displayIntValueWhileSliding ? new ChatComponentText(String.valueOf(this.getIntValue())) : this.formatter.format(this.option.getValue());
