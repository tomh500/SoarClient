...
public class BlockColors {
    ...
    public static BlockColors init() {
        ...
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> {
            ...
            return worldIn != null && pos != null && (type == BlockDoublePlant.EnumPlantType.GRASS || type == BlockDoublePlant.EnumPlantType.FERN) ? BiomeColorHelper.getGrassColorAtPos(worldIn, state.getValue(BlockDoublePlant.HALF) == BlockDoublePlant.EnumBlockHalf.UPPER ? pos.down() : pos) : -1;
        }, Blocks.double_plant);
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> {
        ...
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> worldIn != null && pos != null ? BiomeColorHelper.getGrassColorAtPos(worldIn, pos) : ColorizerGrass.getGrassColor(0.5D, 1.0D), Blocks.grass);
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> {
        ...
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) ->
                worldIn != null && pos != null ? BiomeColorHelper.getFoliageColorAtPos(worldIn, pos) : ColorizerFoliage.getFoliageColorBasic(), Blocks.leaves2);
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) ->
                worldIn != null && pos != null ? BiomeColorHelper.getWaterColorAtPos(worldIn, pos) : -1, Blocks.water, Blocks.flowing_water);
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) ->
                worldIn != null && pos != null ? BiomeColorHelper.getGrassColorAtPos(worldIn, pos) : -1, Blocks.reeds);
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> {
        ...
        INSTANCE.registerBlockColorHandler((state, worldIn, pos, tintIndex) -> worldIn != null && pos != null ? BiomeColorHelper.getFoliageColorAtPos(worldIn, pos) : ColorizerFoliage.getFoliageColorBasic(), Blocks.vine);
