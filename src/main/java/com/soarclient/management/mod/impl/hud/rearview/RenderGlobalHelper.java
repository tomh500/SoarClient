...
public final class RenderGlobalHelper {
	...
	public boolean settingsChanged() {
		return fancy_graphics != mc.gameSettings.fancyGraphics || ambient_occlusion != mc.gameSettings.ambientOcclusion;
	}

	public void switchTo() {
		if (orig == null)
			orig = mc.renderGlobal;
		if (orig.getTheWorld() != rg.getTheWorld()) {
			rg.setWorldAndLoadRenderers(orig.getTheWorld());
			getSettings();
