...
public class HttpUtils {
	...
	public static JsonObject postJson(String url, Object request) {
		...
		HttpURLConnection connection = setupConnection(url, USER_AGENT, 5000, false);
	...
	public static String readResponse(HttpURLConnection connection) {
		...
		if (redirection != null) {
			return readResponse(setupConnection(redirection, USER_AGENT, 5000, false));
		}
	...
	public static JsonObject readJson(String url, Map<String, String> headers) {
		return readJson(url, headers, USER_AGENT);
	}
