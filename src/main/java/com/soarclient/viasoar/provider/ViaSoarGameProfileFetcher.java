package com.soarclient.viasoar.provider;
...
public class ViaSoarGameProfileFetcher extends GameProfileFetcher {

	public static final HttpAuthenticationService AUTHENTICATION_SERVICE = new YggdrasilAuthenticationService(
			Proxy.NO_PROXY, "");
	public static final MinecraftSessionService SESSION_SERVICE = AUTHENTICATION_SERVICE
			.createMinecraftSessionService();
	public static final GameProfileRepository GAME_PROFILE_REPOSITORY = AUTHENTICATION_SERVICE
	...
	public UUID loadMojangUUID(String playerName) throws Exception {
		...
		GAME_PROFILE_REPOSITORY.findProfilesByNames(new String[] { playerName }, Agent.MINECRAFT,
