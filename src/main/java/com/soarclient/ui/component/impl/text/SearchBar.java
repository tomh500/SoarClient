...
public class SearchBar extends Component {
	...
	private void drawCursor() {
		...
		if (cursorPosition != selectionEnd) {
			...
			float selectionWidth = Skia.getTextWidth(text.substring(start, end), Fonts.getRegular(16));
			float selectionOffset = Skia.getTextWidth(text.substring(0, start), Fonts.getRegular(16));
