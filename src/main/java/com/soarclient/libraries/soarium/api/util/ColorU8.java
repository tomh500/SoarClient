...
public interface ColorU8 {
	...
	/**
	 * The maximum value of a color component. Used for converting normalizing
	 * floats to integers.
	 */
	float COMPONENT_RANGE = (float) COMPONENT_MASK;

	/**
	 * The multiplicative inverse of (value / COMPONENT_RANGE). Used for converting
	 * integers to normalized floats.
	 */
	 ...
	 * @return The floating point value of the integer component in the range of
	 *         0.0..1.0
	 */
