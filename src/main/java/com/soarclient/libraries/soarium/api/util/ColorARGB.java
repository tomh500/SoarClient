 ...
 * packed integer colors in ARGB format. This packed format is used by most of
 * Minecraft, but special care must be taken to pack it into ABGR format before
 * passing it to OpenGL attributes.
 *
...
public class ColorARGB implements ColorU8 {
	...
	/**
	 * Packs the specified color components into big-endian format for consumption
	 * by OpenGL.
	 * 
	...
	public static int pack(int r, int g, int b, int a) {
		return (a & COMPONENT_MASK) << ALPHA_COMPONENT_OFFSET | (r & COMPONENT_MASK) << RED_COMPONENT_OFFSET
				| (g & COMPONENT_MASK) << GREEN_COMPONENT_OFFSET | (b & COMPONENT_MASK) << BLUE_COMPONENT_OFFSET;
	}

	/**
	 * Packs the specified color components into big-endian format for consumption
	 * by OpenGL. The alpha channel is fully opaque.
	 * 
	 * @param r The red component of the color
	 * @param g The green component of the color
	 * @param b The blue component of the color
	...
	/**
	 * Swizzles from ARGB format into ABGR format, replacing the alpha component
	 * with {@param alpha}.
	 */
	...
	/**
	 * Swizzles from ARGB format into ABGR format, replacing the alpha component
	 * with {@param alpha}. The alpha component is mapped from [0.0, 1.0] to [0,
	 * 255].
	 */
