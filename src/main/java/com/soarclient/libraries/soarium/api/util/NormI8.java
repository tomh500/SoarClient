...
/**
 * Provides some utilities for working with packed normal vectors. Each normal
 * component provides 8 bits of precision in the range of [-1.0,1.0].
 *
 * | 32 | 24 | 16 | 8 | | 0000 0000 | 0110 1100 | 0110 1100 | 0110 1100 | |
 * Padding | X | Y | Z |
 */
public class NormI8 {
	...
	/**
	 * Constant value which can be multiplied with a floating-point vector component
	 * to get the normalized value. The multiplication is slightly faster than a
	 * floating point division, and this code is a hot path which justifies it.
	 */
	...
	/**
	 * Packs the specified vector components into a 32-bit integer in XYZ ordering
	 * with the 8 bits of padding at the end.
	 * 
	...
	/**
	 * Encodes a float in the range of -1.0..1.0 to a normalized unsigned integer in
	 * the range of 0..255 which can then be passed to graphics memory.
	 */
	private static int encode(float comp) {
		// TODO: is the clamp necessary here? our inputs should always be normalized
		// vector components
		return ((int) (MathHelper.clamp_float(comp, -1.0F, 1.0F) * COMPONENT_RANGE) & 255);
	}

	/**
	 * Unpacks the x-component of the packed normal, denormalizing it to a float in
	...
	/**
	 * Unpacks the y-component of the packed normal, denormalizing it to a float in
	 * the range of -1.0..1.0.
	 * 
	 * @param norm The packed normal
	 */
	...
	/**
	 * Unpacks the z-component of the packed normal, denormalizing it to a float in
	 * the range of -1.0..1.0.
	 * 
	 * @param norm The packed normal
	 */
	...
	/**
	 * Flips the direction of a packed normal by negating each component.
	 * (multiplication by -1)
	 * 
	 * @param norm The packed normal
	 */
