...
public class GuiSoariumSettings extends GuiScreen {
	...
	private static GameSettings.Options[] OPTIONS = new GameSettings.Options[] { GameSettings.Options.GRAPHICS,
			GameSettings.Options.RENDER_DISTANCE, GameSettings.Options.FRAMERATE_LIMIT,
			GameSettings.Options.VIEW_BOBBING, GameSettings.Options.GUI_SCALE,
	...
	public void initGui() {
		...
		options.add(new GuiButton(202, 0, 0, 150, 20, SoariumI18n.get("soarium.details")));
		options.add(new GuiButton(203, 0, 0, 150, 20, SoariumI18n.get("soarium.performances")));
		options.add(new GuiButton(204, 0, 0, 150, 20, SoariumI18n.get("soarium.animations")));
		options.add(new GuiButton(205, 0, 0, 150, 20, SoariumI18n.get("soarium.advances")));
	...
	public void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 201) {
			this.mc.displayGuiScreen(new GuiQualitySettings(this));
		}
	}
}
