...
public class ChunkRenderList {
    ...
    public void sortSections(SectionPos cameraPos, int[] sortItems) {
        var cameraX = MathHelper.clamp_int(cameraPos.getX() - this.region.getChunkX(), 0, RenderRegion.REGION_WIDTH - 1);
        var cameraY = MathHelper.clamp_int(cameraPos.getY() - this.region.getChunkY(), 0, RenderRegion.REGION_HEIGHT - 1);
        var cameraZ = MathHelper.clamp_int(cameraPos.getZ() - this.region.getChunkZ(), 0, RenderRegion.REGION_LENGTH - 1);
