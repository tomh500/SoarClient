...
public class CameraTransform {
	// We want to reduce the precision of the deltas to avoid seams along
	// chunk/region boundaries. This is done by
	// ensuring the camera position would be the same if we did cameraPos + 0 - 0 as
	// if we did cameraPos + 128 - 128.
