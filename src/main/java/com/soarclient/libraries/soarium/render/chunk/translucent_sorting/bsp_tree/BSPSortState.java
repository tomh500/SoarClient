...
class BSPSortState {
	 ...
	 * 
	 * Format: 32 bits, elements described as [length in bits: description] header
	 * at position 0: 0b1[4: width index][10: delta count][17: first index] header
	 * at position 1: 0b[32: base delta] deltas at position 2..n: 0b[width:
	 * delta]...
	 * 
	 * delta bit widths: 1x32b, 2x16b, 3x10b, 4x8b, 5x6b, 6x5b, 8x4b, 10x3b, 16x2b,
	 * 32x1b
	 */
	...
	private IntConsumer indexConsumer = (int index) -> TranslucentData.writeQuadVertexIndexes(this.indexBuffer, index);

	private IntConsumer indexMapConsumer = (int index) -> TranslucentData.writeQuadVertexIndexes(this.indexBuffer,
			this.indexMap[index]);
