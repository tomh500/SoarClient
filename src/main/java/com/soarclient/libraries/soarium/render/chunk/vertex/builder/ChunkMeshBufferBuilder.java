package com.soarclient.libraries.soarium.render.chunk.vertex.builder;
...
public class ChunkMeshBufferBuilder {
	...
	public void push(ChunkVertexEncoder.Vertex[] vertices, int materialBits) {
		...
		this.encoder.write(MemoryUtil.memAddress(this.buffer, this.vertexCount * this.stride), materialBits, vertices,
				this.sectionIndex);
		this.vertexCount += 4;
	}
