...
class Group {
	...
	private boolean planeTriggered(double start, double end) {
		return start < this.distances.getEnd() && end > this.distances.getStart() && AlignableNormal.queryRange(
				this.facePlaneDistances, (float) (start - this.baseDistance), (float) (end - this.baseDistance));
	}
	 ...
	 * 
	 * TODO: how common are collisions and are they bad? If they are common, use
	 * second or different hash
	 */
