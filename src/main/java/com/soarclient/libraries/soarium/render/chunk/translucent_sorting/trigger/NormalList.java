...
import com.soarclient.libraries.soarium.util.interval_tree.Interval;
import com.soarclient.libraries.soarium.util.interval_tree.IntervalTree;
...
public class NormalList {
	...
	private double normalDotDouble(Vector3dc v) {
		return org.joml.Math.fma(this.normal.x, v.x(), org.joml.Math.fma(this.normal.y, v.y(), this.normal.z * v.z()));
	}
