...
/**
 * Adaptation of {@link ArrayLightDataCache} that stores data for only one block
 * and its neighbors.
 */
public class SingleBlockLightDataCache extends LightDataAccess {
	// Radius of 2 is required: block models may create geometry in up to a 3x3x3
	// region, which requires light to be
