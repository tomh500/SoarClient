...
public class ModelQuadFlags {
	...
	/**
	 * Indicates that the quad is aligned to the block grid. This flag is only set
	 * if {@link #IS_PARALLEL} is set.
	 */
	...
	/**
	 * @return True if the bit-flag of {@link ModelQuadFlags} contains the given
	 *         flag
	 */
	...
	/**
	 * Calculates the properties of the given quad. This data is used later by the
	 * light pipeline in order to make certain optimizations.
	 */
