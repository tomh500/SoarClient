...
/**
 * Defines the orientation of vertices in a model quad. This information be used
 * to re-orient the quad's vertices to a consistent order, eliminating a number
 * of shading issues caused by anisotropy problems.
 */
