 ...
 * blocks in a given chunk and its direct neighbors. This is considerably faster
 * than using a hash table to lookup values for a given block position and can
 * be re-used by {@link LevelSlice} to avoid allocations.
 */
