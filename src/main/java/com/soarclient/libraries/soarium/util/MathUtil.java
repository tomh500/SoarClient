...
public class MathUtil {
	/**
	 * @return True if the specified number is greater than zero and is a power of
	 *         two, otherwise false
	 */
	...
	/**
	 * <p>
	 * Rounds the integer {@param num} up to the next multiple of
	 * {@param alignment}. This multiple *MUST* be a power-of-two, or undefined
	 * behavior will occur.
	 * </p>
	 *
	 ...
	 * <p>
	 * Reference: <a href=
	 * "https://stackoverflow.com/questions/23900328/are-floats-bit-patterns-ordered">StackOverflow
	 * Answer</a>
	 */
