package com.soarclient.libraries.occlusionculling;

import java.util.Arrays;
import java.util.BitSet;

import com.soarclient.libraries.occlusionculling.cache.ArrayOcclusionCache;
import com.soarclient.libraries.occlusionculling.cache.OcclusionCache;
import com.soarclient.libraries.occlusionculling.util.MathUtilities;
...
public class OcclusionCullingInstance {
	 ...
	 * @param position
	 * @param faceData       contains rather this Block is on the outside for a
	 *                       given face
