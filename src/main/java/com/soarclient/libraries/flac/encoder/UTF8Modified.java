...
public class UTF8Modified {
	...
	static long[] limits = { oneByteLimit, twoByteLimit, threeByteLimit, fourByteLimit, fiveByteLimit, sixByteLimit,
			sevenByteLimit };
	 ...
	 * 
	 * @param value value to convert to extended UTF8(value must be positive and 36
	 *              bits or less in size)
