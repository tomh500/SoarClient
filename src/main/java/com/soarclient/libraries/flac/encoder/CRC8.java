...
public class CRC8 {
	...
	/**
	 * Constructor. Creates a CRC8 object that is ready to be used. Next step would
	 * be to call updateCRC8 with appropriate data.
	 */
	public CRC8() {
		reset();
	}
	...
	/**
	 * Finalize the checksum, and return the value. After this is called, you must
	 * call reset() before attempting a new checksum.
	 * 
