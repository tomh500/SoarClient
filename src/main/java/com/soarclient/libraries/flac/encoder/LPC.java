...
public class LPC {
	...
	/**
	 * Calculate an LPC using the given Auto-correlation data. Static method used
	 * since this is slightly faster than a more strictly object-oriented approach.
	 *
	 ...
	 * @param priorLPC Prior order LPC to use(may be any order lower than our target
	 *                 LPC)
	 *
	 */
	 ...
	 */
	public static void createAutoCorrelation(long[] R, int[] samples, int count, int start, int increment,
			int maxOrder) {
	 ...
	 * 
	 * @param samples         Samples to apply window to. Values in this array are
	 *                        left unaltered.
	 * @param count           number of samples to use
	 * @param start           index of samples array to start at
	 * @param increment       number of indices to increment between valid
	 *                        samples(for interleaved arrays)
	 * @param windowedSamples array containing windowed values. Return values are
