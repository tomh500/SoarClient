...
public class MetadataBlockHeader {
	...
	/**
	 * Enum containing the different Metadata block types. See the FLAC spec for
	...
	public enum MetadataBlockType {
		...
		STREAMINFO,
		/**
		 * A meta-block to pad the stream, allowing other meta-data to be written in the
		 * future without re-writing the entire stream.
		 */
		PADDING,
	...
	/**
	 * Create a meta-data block header of the given type, and return the result in a
	 * new EncodedElement(so data is ready to be placed directly in FLAC stream)
	 *
	 ...
	 */
	public static EncodedElement getMetadataBlockHeader(boolean lastBlock, MetadataBlockType type, int length) {
