...
public class AudioStreamEncoder {
	...
	/**
	 * Encodes the given AudioInputStream, using the given FLACEncoder. FLACEncoder
	 * must be in a state to accept samples and encode(FLACOutputStream,
	 ...
	 */
	public static int encodeAudioInputStream(AudioInputStream sin, int maxRead, FLACEncoder flac, boolean useThreads)
	...
	/**
	 * Checks whether the given AudioFormat can be properly encoded by this FLAC
	 * library.
	 * 
	 * @param format AudioFormat to test for support.
	 * @return Bit positions set according to issue: Bit Position : Problem-area 0 :
	 *         Channel count unsupported 1 : Sample size unsupported 2 : Sample Rate
	 *         unsupported 3 : Encoding Type Unsupported 4-7: unused, always zero.
