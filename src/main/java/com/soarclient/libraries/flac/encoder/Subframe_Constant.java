...
public class Subframe_Constant extends Subframe {
	/**
	 * For debugging: Higher values equals greater output, generally by increments
	 * of 10.
	 */
	...
	public int encodeSamples(int[] samples, int count, int start, int skip, EncodedElement data, int offset,
			int bitsPerSample) {
		if (DEBUG_LEV > 0) {
