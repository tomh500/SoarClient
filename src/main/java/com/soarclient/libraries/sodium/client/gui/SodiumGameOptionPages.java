...
import com.soarclient.libraries.sodium.client.gui.SodiumGameOptions.GraphicsQuality;
...
import com.soarclient.libraries.sodium.client.gui.options.OptionImpl;
import com.soarclient.libraries.sodium.client.gui.options.OptionPage;
import com.soarclient.libraries.sodium.client.gui.options.control.ControlValueFormatter;
import com.soarclient.libraries.sodium.client.gui.options.control.CyclingControl;
import com.soarclient.libraries.sodium.client.gui.options.control.SliderControl;
import com.soarclient.libraries.sodium.client.gui.options.control.TickBoxControl;
import com.soarclient.libraries.sodium.client.gui.options.named.GraphicsMode;
import com.soarclient.libraries.sodium.client.gui.options.named.ParticleMode;
import com.soarclient.libraries.sodium.client.gui.options.storage.MinecraftOptionsStorage;
import com.soarclient.libraries.sodium.client.gui.options.storage.SodiumOptionsStorage;
	...
	public static OptionPage general() {
		...
		groups.add(OptionGroup.createBuilder()
				...
				.add(OptionImpl.createBuilder(int.class, vanillaOpts)
						...
						.setBinding((opts, value) -> opts.gammaSetting = (float) value.intValue() * 0.01F,
								opts -> (int) (opts.gammaSetting / 0.01F))
						.build())
		...
		groups.add(OptionGroup.createBuilder()
				...
				.add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
						...
						}, opts -> opts.enableVsync).setImpact(OptionImpact.VARIES).build())
				.add(OptionImpl.createBuilder(int.class, vanillaOpts)
						...
						.setBinding((opts, value) -> opts.limitFramerate = value, opts -> opts.limitFramerate).build())
				.build());
		groups.add(OptionGroup.createBuilder()
				.add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
				...
				.build());
		return new OptionPage(new ChatComponentTranslation("stat.generalButton", new Object[0]),
				ImmutableList.copyOf(groups));
	}

	public static OptionPage quality() {
		List<OptionGroup> groups = new ArrayList();
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(GraphicsMode.class, vanillaOpts)
		...
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(GraphicsQuality.class, sodiumOpts)
				...
				.add(OptionImpl.createBuilder(GraphicsQuality.class, sodiumOpts)
						...
						.setTooltip(
								new ChatComponentTranslation("sodium.options.weather_quality.tooltip", new Object[0]))
						.setControl(option -> new CyclingControl(option, GraphicsQuality.class))
				...
				.add(OptionImpl.createBuilder(GraphicsQuality.class, sodiumOpts)
						...
						.setTooltip(
								new ChatComponentTranslation("sodium.options.leaves_quality.tooltip", new Object[0]))
						.setControl(option -> new CyclingControl(option, GraphicsQuality.class))
				...
				.add(OptionImpl.createBuilder(ParticleMode.class, vanillaOpts)
						...
						.setTooltip(
								new ChatComponentTranslation("sodium.options.particle_quality.tooltip", new Object[0]))
						...
						.setImpact(OptionImpact.MEDIUM).build())
				.add(OptionImpl.createBuilder(LightingQuality.class, sodiumOpts)
						.setName(new ChatComponentTranslation("options.ao", new Object[0]))
						.setTooltip(
								new ChatComponentTranslation("sodium.options.smooth_lighting.tooltip", new Object[0]))
				...
				.add(OptionImpl.createBuilder(int.class, sodiumOpts)
						...
						.setControl(option -> new SliderControl(option, 0, 7, 1,
								ControlValueFormatter.quantityOrDisabled("sodium.options.biome_blend.value",
										"gui.none")))
				...
				.add(OptionImpl.createBuilder(int.class, sodiumOpts)
						...
						.setTooltip(
								new ChatComponentTranslation("sodium.options.entity_distance.tooltip", new Object[0]))
						.setControl(
								option -> new SliderControl(option, 50, 500, 25, ControlValueFormatter.percentage()))
						.setBinding(
								(opts, value) -> opts.quality.entityDistanceScaling = (float) value.intValue() / 100.0F,
								opts -> Math.round(opts.quality.entityDistanceScaling * 100.0F))
						.setImpact(OptionImpact.MEDIUM).build())
				.add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
						.setName(new ChatComponentTranslation("options.entityShadows", new Object[0]))
						.setTooltip(
								new ChatComponentTranslation("sodium.options.entity_shadows.tooltip", new Object[0]))
						.setControl(TickBoxControl::new)
		...
		groups.add(OptionGroup.createBuilder()
				...
				.build());
		return new OptionPage(new ChatComponentTranslation("sodium.options.pages.quality", new Object[0]),
				ImmutableList.copyOf(groups));
	}

	public static OptionPage advanced() {
		List<OptionGroup> groups = new ArrayList();
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
				...
				.setControl(TickBoxControl::new)
				.setBinding((opts, value) -> opts.advanced.useChunkMultidraw = value,
						opts -> opts.advanced.useChunkMultidraw)
				.setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).setImpact(OptionImpact.EXTREME)
				.setEnabled(
						MultidrawChunkRenderBackend.isSupported(sodiumOpts.getData().advanced.ignoreDriverBlacklist))
				.build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						...
						.setTooltip(new ChatComponentTranslation("sodium.options.use_vertex_objects.tooltip",
								new Object[0]))
						.setControl(TickBoxControl::new)
						.setBinding((opts, value) -> opts.advanced.useVertexArrayObjects = value,
								opts -> opts.advanced.useVertexArrayObjects)
						.setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).setImpact(OptionImpact.LOW).build())
				.build());
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
				.setName(new ChatComponentTranslation("sodium.options.use_block_face_culling.name", new Object[0]))
				.setTooltip(
						new ChatComponentTranslation("sodium.options.use_block_face_culling.tooltip", new Object[0]))
				.setControl(TickBoxControl::new).setImpact(OptionImpact.MEDIUM)
				.setBinding((opts, value) -> opts.advanced.useBlockFaceCulling = value,
				...
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						...
						.setTooltip(new ChatComponentTranslation("sodium.options.use_compact_vertex_format.tooltip",
								new Object[0]))
						.setControl(TickBoxControl::new).setImpact(OptionImpact.MEDIUM)
						.setBinding((opts, value) -> opts.advanced.useCompactVertexFormat = value,
								opts -> opts.advanced.useCompactVertexFormat)
						.setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						.setName(new ChatComponentTranslation("sodium.options.use_fog_occlusion.name", new Object[0]))
						.setTooltip(
								new ChatComponentTranslation("sodium.options.use_fog_occlusion.tooltip", new Object[0]))
						.setControl(TickBoxControl::new)
						.setBinding((opts, value) -> opts.advanced.useFogOcclusion = value,
								opts -> opts.advanced.useFogOcclusion)
						.setImpact(OptionImpact.MEDIUM).setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						.setName(
								new ChatComponentTranslation("sodium.options.translucency_sorting.name", new Object[0]))
						.setTooltip(new ChatComponentTranslation("sodium.options.translucency_sorting.tooltip",
								new Object[0]))
						.setControl(TickBoxControl::new)
						.setBinding((opts, value) -> opts.advanced.translucencySorting = value,
								opts -> opts.advanced.translucencySorting)
						.setImpact(OptionImpact.MEDIUM).setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						...
						.setTooltip(new ChatComponentTranslation("sodium.options.use_entity_culling.tooltip",
								new Object[0]))
						.setControl(TickBoxControl::new).setImpact(OptionImpact.MEDIUM)
						.setBinding((opts, value) -> opts.advanced.useEntityCulling = value,
								opts -> opts.advanced.useEntityCulling)
						.build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						.setName(
								new ChatComponentTranslation("sodium.options.use_particle_culling.name", new Object[0]))
						.setTooltip(new ChatComponentTranslation("sodium.options.use_particle_culling.tooltip",
								new Object[0]))
						.setControl(TickBoxControl::new).setImpact(OptionImpact.LOW)
						.setBinding((opts, value) -> opts.advanced.useParticleCulling = value,
								opts -> opts.advanced.useParticleCulling)
						.build())
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						...
						.setBinding((opts, value) -> opts.advanced.animateOnlyVisibleTextures = value,
								opts -> opts.advanced.animateOnlyVisibleTextures)
						.build())
				.build());
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
				...
				.setTooltip(new ChatComponentTranslation("sodium.options.allow_direct_memory_access.tooltip",
						new Object[0]))
				.setControl(TickBoxControl::new).setImpact(OptionImpact.HIGH)
				.setBinding((opts, value) -> opts.advanced.allowDirectMemoryAccess = value,
						opts -> opts.advanced.allowDirectMemoryAccess)
				.build()).build());
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
				.setName(new ChatComponentTranslation("sodium.options.ignore_driver_blacklist.name", new Object[0]))
				.setTooltip(
						new ChatComponentTranslation("sodium.options.ignore_driver_blacklist.tooltip", new Object[0]))
				.setControl(TickBoxControl::new)
				.setBinding((opts, value) -> opts.advanced.ignoreDriverBlacklist = value,
						opts -> opts.advanced.ignoreDriverBlacklist)
				.build()).build());
		return new OptionPage(new ChatComponentTranslation("sodium.options.pages.advanced", new Object[0]),
				ImmutableList.copyOf(groups));
	}
		...
		groups.add(OptionGroup.createBuilder().add(OptionImpl.createBuilder(int.class, sodiumOpts)
				...
				.setControl(o -> new SliderControl(o, 0, Runtime.getRuntime().availableProcessors(), 1,
						ControlValueFormatter
								.quantityOrDisabled("sodium.options.threads.value", "sodium.options.default")))
				...
				.add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
						...
						.setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD).build())
				.build());
		return new OptionPage(new ChatComponentTranslation("sodium.options.pages.performance", new Object[0]),
				ImmutableList.copyOf(groups));
	}
}
