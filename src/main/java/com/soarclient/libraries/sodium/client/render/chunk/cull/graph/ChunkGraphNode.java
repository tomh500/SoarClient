...
public class ChunkGraphNode {
	...
	public void updateCullingState(EnumFacing flow, short parent) {
		...
		this.cullingState = (short) (this.cullingState
				| (short) ((int) (this.visibilityData >> (inbound << 3) & 255L)));
	...
	public boolean isCulledByFrustum(FrustumExtended frustum) {
		...
		return !frustum.fastAabbTest(x - 1.125F, y - 1.125F, z - 1.125F, x + 16.0F + 1.125F, y + 16.0F + 1.125F,
				z + 16.0F + 1.125F);
	}
