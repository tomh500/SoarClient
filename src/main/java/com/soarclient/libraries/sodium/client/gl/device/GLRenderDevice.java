...
import com.soarclient.libraries.sodium.client.gl.state.GlStateTracker;
import com.soarclient.libraries.sodium.client.gl.tessellation.GlFallbackTessellation;
...
import com.soarclient.libraries.sodium.client.gl.tessellation.GlVertexArrayTessellation;
	...
	private class ImmediateCommandList implements CommandList {
		...
		public void copyBufferSubData(GlBuffer src, GlMutableBuffer dst, long readOffset, long writeOffset, long bytes) {
			if (writeOffset + bytes > dst.getSize()) {
				...
				GlFunctions.BUFFER_COPY.glCopyBufferSubData(36662, 36663, readOffset, writeOffset, bytes);
			}
		}
