...
import com.soarclient.libs.sodium.client.render.chunk.format.hfp.HFPModelVertexType;
import com.soarclient.libs.sodium.client.render.chunk.format.sfp.SFPModelVertexType;
...
public class ChunkBufferSorter {
	public static void sortStandardFormat(ChunkVertexType vertexType, ByteBuffer buffer, int bufferLen, float x, float y, float z) {
		...
		if (vertexType.getClass() == HFPModelVertexType.class) {
			...
			if (vertexType.getClass() != SFPModelVertexType.class) {
				return;
			}
