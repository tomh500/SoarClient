...
public enum GlVertexArrayFunctions {
	...
	static GlVertexArrayFunctions load(ContextCapabilities capabilities) {
		if (capabilities.OpenGL30) {
			...
			return capabilities.GL_ARB_vertex_array_object ? ARB : UNSUPPORTED;
		}
	}

	public abstract void glBindVertexArray(int integer);

	public abstract int glGenVertexArrays();

	public abstract void glDeleteVertexArrays(int integer);
}
